...
class Author(models.Model):
    name = models.CharField(default='Name not given')
...
class Article(models.Model):
    ...
    snippet = models.CharField(default='news snippets', null=False)
    content = RichTextUploadingField()
    thumbnail = models.ImageField(upload_to="articles_thumbnail/", blank=True, null=True)
